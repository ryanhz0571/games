...
| 🦊 数字大陆 | 跑酷式初一数学挑战：怪物追击、每 5 秒一题、子关卡与等级 | [开始学习](https://ryanhz0571.github.io/games/math-game/) |
...
一个跑酷式的数学学习游戏，采用任天堂（马力欧）风格：狐狸在前面跑，怪物在后面追，每 5 秒出一道题，答对甩开怪物、答错被逼近。按浙教版初一数学把内容拆成「分组 → 子关卡」，前两课已可玩：
